...
import {
  ...
  type HaendlerRow,
} from "../utils/haendlerImportExport";
...
export default function HaendlerverwaltungView({ onBack }: Props) {
  ...
  return (
    <div className="haendlerverwaltung-view">
      ...
      {importMessage && (
        <p className={importMessage.includes("Fehler") ? "haendlerverwaltung-error" : "haendlerverwaltung-import-ok"}>
          {importMessage}
        </p>
      )}

      <section className="haendlerverwaltung-import-export">
        <h2>Import / Export</h2>
        <div className="haendlerverwaltung-io-buttons">
      ...
      <section className="haendlerverwaltung-form">
        <div className="haendlerverwaltung-form-title-row">
        ...
        <div className="haendlerverwaltung-form-actions">
          {editing !== null && (
      ...
      <section className="haendlerverwaltung-list">
        ...
        {loading ? (
          ...
          <p className="haendlerverwaltung-empty">Noch keine Händler angelegt.</p>
        ) : (
          <ul>
            {list.map((h) => (
