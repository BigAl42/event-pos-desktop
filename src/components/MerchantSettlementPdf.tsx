import "./MerchantSettlementPdf.css";
...
export function MerchantSettlementPdf({ data }: Props) {
  ...
  return (
    <div className="merchant-settlement-pdf" data-testid="merchant-settlement-pdf">
      <header className="merchant-settlement-pdf__header">
        <div>
          <div className="merchant-settlement-pdf__title">Händlerabrechnung</div>
          <div className="merchant-settlement-pdf__subtitle">Abrechnungslauf: {l.name}</div>
        </div>
        <div className="merchant-settlement-pdf__meta">
          <div>
      ...
      <section className="merchant-settlement-pdf__grid">
        <div className="merchant-settlement-pdf__card">
          <div className="merchant-settlement-pdf__cardTitle">Händler (Stammdaten)</div>
          <div className="merchant-settlement-pdf__kv">
        ...
        <div className="merchant-settlement-pdf__card">
          <div className="merchant-settlement-pdf__cardTitle">Abrechnungslauf</div>
          <div className="merchant-settlement-pdf__kv">
            <div className="k">Name</div>
      ...
      <section className="merchant-settlement-pdf__summe">
        <div className="merchant-settlement-pdf__summeLabel">Gesamtsumme</div>
        <div className="merchant-settlement-pdf__summeValue">{formatMoneyEUR(summe)}</div>
      </section>

      <section className="merchant-settlement-pdf__facts">
        <div className="fact">
      ...
      <footer className="merchant-settlement-pdf__footer">
        <div className="line" />
