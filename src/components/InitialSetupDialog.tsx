...
import "./InitialSetupDialog.css";

type Props = { onDone: () => void };

export default function InitialSetupDialog({ onDone }: Props) {
  ...
  return (
    <div className="initial-setup">
      <div className="initial-setup-card">
        ...
        <div className="initial-setup-form">
          <label>
        ...
        {error && <p className="initial-setup-error">{error}</p>}
