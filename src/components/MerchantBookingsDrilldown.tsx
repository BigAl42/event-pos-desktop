...
export default function MerchantBookingsDrilldown({ haendlernummer, haendlerName, onClose }: Props) {
  ...
  return (
    <div className="settlement-view">
      ...
      {loading ? (
        ...
        <p className="settlement-leer">Keine Buchungen für diesen Händler im aktuellen Abrechnungslauf.</p>
      ) : (
        <div id="haendler-drilldown-print-root">
          {Object.entries(groups).map(([kassenId, items]) => (
            <section key={kassenId} className="settlement-kassen-gruppe">
