...
export function buildNotfallExcel(dto: NotfallExportDto): ArrayBuffer {
...
export function parseNotfallExcel(buffer: ArrayBuffer): NotfallExportDto {
...
export function buildNotfallCsv(dto: NotfallExportDto): string {
  const lines: string[] = [];
  const header = [
    "record_type",
    "key",
...
export function parseNotfallCsv(content: string): NotfallExportDto {
